  ...
  if (existingEvents.length === 0) {
    await db.insert(events).values([
      ...
      },
      {
        ...
        winner: null,
        format: "Single elimination, ISO 5495 paired comparison",
        keyHighlights: "The manufacturer's home territory. Despite ample time to plan, the event was the worst WEC ever ran. This was the turning point.",
        description: "The event that proved the manufacturer could not see what the competitors saw. WEC became independent.",
        championProduct: "Pre-product era",
        sponsor: "Italian espresso machine manufacturer",
        isUpcoming: false,
        sortOrder: 2,
      },
      {
        ...
        venue: "TBC",
        winner: null,
        format: "32 competitors, single elimination, ISO 5495 paired comparison",
        keyHighlights: "The inaugural year of the Champion's Coffee Product. The first independently-run WEC. The first time the champion gets a globally distributed product.",
        description: "This is the first year. There will never be another first. The first champion's coffee product. The first independently-run WEC.",
        championProduct: "To be announced - first ever Champion's Coffee Product",
        sponsor: "Seeking title sponsor and green sponsor",
        isUpcoming: true,
        sortOrder: 1,
      },
    ]);
